 ...
 */
    ...
    MON("Manu", S_HUMAN, LVL(2, 30, 0, 127, 0),
        (G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
	  NO_ATTK),
	SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
    ...
    /*    MON("Medium Manu", S_HUMAN, LVL(4, 30, -10, 127, 0),
        (G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(0, 0, MZ_HUGE),
        M1_FLY | M1_BREATHLESS | M1_AMORPHOUS 
         M2_MALE,
	 M3_INFRAVISIBLE, CLR_BLUE),*/
    MON("Manuu", S_HUMAN, LVL(18, 30, -10, 127, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400,
	    MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_OMNIVORE, M2_HUMAN | M2_DOMESTIC | M2_WANDER, M3_INFRAVISIBLE,
        HI_DOMESTIC),
